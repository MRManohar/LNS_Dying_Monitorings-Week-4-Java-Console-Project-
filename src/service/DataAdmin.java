...
public class DataAdmin {
	...
	//To store the admin registration details in Excel Workbook
	String filename = "C:\\Users\\mlaks\\OneDrive\\Desktop\\FSJ\\ProGrad_S-52\\S-2-2_Week-4\\BackEnd Data\\AdminData.xls";
	int i=1;
	...
	public HSSFWorkbook excelGenerate(Registrations registrations, List<Registrations> list) throws IOException
	{
		if(checkFile.exists())
		{
			...
			try
			{
				...
				System.out.println("Error in DataAdmin if it existing");
			}
			return null;
		}	//close if
		...
		else
		{
			...
			{
				System.out.println("Error in DataAdmin if it is not existing");
			}
			return null;
		}	//close else
