...
public class DataCustomer {
	String filename = "C:\\Users\\mlaks\\eclipse-workspace\\Dying_Monitroings\\BackEnd Data\\CustomerData.xls";
	int i=1;
	...
	public HSSFWorkbook excelGenerate(Registrations registrations, List<Registrations> list) throws IOException
	{
			...
			try
			{
				...
				for(Registrations fillSheet: list)
				{
					...
					int rowSize = sheet.getPhysicalNumberOfRows();
			      	...
			      	nextRows.createCell(5).setCellValue(fillSheet.getMobileNumber());
	      	  	}
		...
		else
		{
			try
			{
				...
				row.createCell(5).setCellValue("Mobile Number");
